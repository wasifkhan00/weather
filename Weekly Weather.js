...
let success = (gpsLocation) => {
    ...
    fetch(weatherApiAccess).then(respond => {
        ...
        cardsTime.forEach(time => {
                ...
                if (time.innerHTML === 'dayOne') {

                    let newTime = new Date(data.daily[0].dt * 1000);

                    let getFullDay = newTime.getDay();
                    ...
                    if (getFullDay == 6) {
                        getFullDay = 'Satursday';
                    }
                    time.innerHTML = getFullDay;
                ...
                if (time.innerHTML === 'dayTwo') {


                    let newTime = new Date(data.daily[1].dt * 1000);
                ...
                if (time.innerHTML === 'dayThree') {

                    let newTime = new Date(data.daily[2].dt * 1000);
                ...
                if (time.innerHTML === 'dayFour') {

                    let newTime = new Date(data.daily[3].dt * 1000);
                ...
                if (time.innerHTML === 'dayFive') {

                    let newTime = new Date(data.daily[4].dt * 1000);
                ...
                if (time.innerHTML === 'daySix') {
                    let newTime = new Date(data.daily[5].dt * 1000);
                ...
                if (time.innerHTML === 'daySeven') {

                    let newTime = new Date(data.daily[6].dt * 1000);
        ...
        cardWindSpeed.forEach(winds => {
                ...
                if (winds.innerHTML === '10 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[0].wind_speed) + windUnit;
                }

                if (winds.innerHTML === '2 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[1].wind_speed) + windUnit;
                }

                if (winds.innerHTML === '3 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[2].wind_speed) + windUnit;
                }

                if (winds.innerHTML === '4 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[3].wind_speed) + windUnit;
                }

                if (winds.innerHTML === '5 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[4].wind_speed) + windUnit;
                }

                if (winds.innerHTML === '6 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[5].wind_speed) + windUnit;
                }

                if (winds.innerHTML === '7 m/s') {
                    winds.innerHTML = Math.ceil(data.daily[6].wind_speed) + windUnit;
                }
            })
            // WIND FOREach END
        ...
        cardClouds.forEach((clouds) => {
            ...
            if (clouds.innerHTML === '20 %') {
                clouds.innerHTML = data.daily[0].clouds + ' ' + '%';
            }

            if (clouds.innerHTML === '21 %') {
                clouds.innerHTML = data.daily[1].clouds + ' ' + '%';
            }

            if (clouds.innerHTML === '22 %') {
                clouds.innerHTML = data.daily[2].clouds + ' ' + '%';
            }

            if (clouds.innerHTML === '23 %') {
                clouds.innerHTML = data.daily[3].clouds + ' ' + '%';

            }

            if (clouds.innerHTML === '24 %') {
                clouds.innerHTML = data.daily[4].clouds + ' ' + '%';


            }

            if (clouds.innerHTML === '25 %') {
                clouds.innerHTML = data.daily[5].clouds + ' ' + '%';


            }

            if (clouds.innerHTML === '26 %') {
                clouds.innerHTML = data.daily[6].clouds + ' ' + '%';
        ...
        cardUltraVioletRays.forEach((UVRAYS) => {
                ...
                if (UVRAYS.innerHTML === '10 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[0].uvi) + uvRaysUnit;
                }

                if (UVRAYS.innerHTML === '11 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[1].uvi) + uvRaysUnit;
                }

                if (UVRAYS.innerHTML === '12 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[2].uvi) + uvRaysUnit;
                }

                if (UVRAYS.innerHTML === '13 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[3].uvi) + uvRaysUnit;
                }

                if (UVRAYS.innerHTML === '14 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[4].uvi) + uvRaysUnit;
                }

                if (UVRAYS.innerHTML === '15 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[5].uvi) + uvRaysUnit;
                }

                if (UVRAYS.innerHTML === '16 UV') {
                    UVRAYS.innerHTML = Math.ceil(data.daily[6].uvi) + uvRaysUnit;
                }
            })
            // UVRAYS END
        ...
        cardTemperature.forEach((temps) => {
            ...
            if (temps.innerHTML === '25°') {
                let temperatureConverter = Math.ceil(data.daily[0].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }

            if (temps.innerHTML === '26°') {
                let temperatureConverter = Math.ceil(data.daily[1].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }

            if (temps.innerHTML === '27°') {
                let temperatureConverter = Math.ceil(data.daily[2].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }
            if (temps.innerHTML === '28°') {
                let temperatureConverter = Math.ceil(data.daily[3].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }
            if (temps.innerHTML === '29°') {
                let temperatureConverter = Math.ceil(data.daily[4].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }
            if (temps.innerHTML === '30°') {
                let temperatureConverter = Math.ceil(data.daily[5].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }
            if (temps.innerHTML === '31°') {
                let temperatureConverter = Math.ceil(data.daily[6].temp.day - 271);
                temps.innerHTML = temperatureConverter + '°';
            }
        })
        ...
        cardWeatherimage.forEach((images) => {
            ...
            if (images.alt === 'imgOne') {
                ...
                if (data.daily[0].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[0].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[0].clouds < 0) {
            ...
            if (images.alt === 'imgTwo') {
                ...
                if (data.daily[1].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[1].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[1].clouds < 0) {
                    images.src = weatherImages[9]
                }
            ...
            if (images.alt === 'imgThree') {
                ...
                if (data.daily[2].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[2].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[2].clouds < 0) {
                    images.src = weatherImages[9]
                }
            }
            ...
            if (images.alt === 'imgFour') {
                ...
                if (data.daily[3].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[3].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[3].clouds < 0) {
                    images.src = weatherImages[9]
                }
            }
            ...
            if (images.alt === 'imgFive') {
                ...
                if (data.daily[4].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[4].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[4].clouds < 0) {
                    images.src = weatherImages[9]
                }
            }
            ...
            if (images.alt === 'imgSix') {
                ...
                if (data.daily[5].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[5].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[5].clouds < 0) {
                    images.src = weatherImages[9]
                }
            }
            ...
            if (images.alt === 'imgSeven') {
                ...
                if (data.daily[6].clouds >= 50) {
                    images.src = weatherImages[2]
                }

                if (data.daily[6].clouds >= 70) {
                    images.src = weatherImages[3]
                }

                if (data.daily[6].clouds < 0) {
                    images.src = weatherImages[9]
                }
            }
        ...
        cardWeatherDescription.forEach((descrips) => {
                ...
                if (descrips.innerHTML === 'Storming Rain') {
                    descrips.innerHTML = data.daily[0].weather[0].description;
                }

                if (descrips.innerHTML === 'hailStorm') {
                    descrips.innerHTML = data.daily[1].weather[0].description;
                }

                if (descrips.innerHTML === 'ThunderStorm') {
                    descrips.innerHTML = data.daily[2].weather[0].description;
                }

                if (descrips.innerHTML === 'Sunny') {
                    descrips.innerHTML = data.daily[3].weather[0].description;
                }

                if (descrips.innerHTML === 'Cloudy') {
                    descrips.innerHTML = data.daily[4].weather[0].description;
                }

                if (descrips.innerHTML === 'Raining') {
                    descrips.innerHTML = data.daily[5].weather[0].description;
                }

                if (descrips.innerHTML === 'bolt') {
                    descrips.innerHTML = data.daily[6].weather[0].description;
                }
            })
        ...
        allTheCardsContainer.forEach(cards => {
            ...
            if (cards.id === 'containerTwo') {
                cards.addEventListener('click', e => {
                    ...
                    currentHumidity.innerHTML = data.daily[1].humidity + '   %';
            ...
            if (cards.id === 'containerThree') {
                cards.addEventListener('click', e => {
                    ...
                    currentHumidity.innerHTML = data.daily[2].humidity + '   %';
            ...
            if (cards.id === 'containerFour') {
                cards.addEventListener('click', e => {
                    ...
                    currentHumidity.innerHTML = data.daily[3].humidity + '   %';
            ...
            if (cards.id === 'containerFive') {
                cards.addEventListener('click', e => {
                    ...
                    currentHumidity.innerHTML = data.daily[4].humidity + '   %';
            ...
            if (cards.id === 'containerSix') {
                cards.addEventListener('click', e => {
                    ...
                    currentHumidity.innerHTML = data.daily[5].humidity + '   %';
            ...
            if (cards.id === 'containerSeven') {
                cards.addEventListener('click', e => {
                    ...
                    currentHumidity.innerHTML = data.daily[6].humidity + '   %';
